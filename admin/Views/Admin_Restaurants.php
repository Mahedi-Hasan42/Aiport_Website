...
<html>
    ...
    <body onload="initClock()">
        ...
        <form method="get">
            ...
            <button formaction="Admin_Restaurants.php" id="Restaurants"><i class="fa-solid fa-utensils"></i>&nbsp;Restaurants</button><br><br>
        ...
        function logout() {
            ...
            <!--Content Name-->
            <div id="content_Name"><p>Restaurants</p></div>
            <!--Content Form-->
            ...
            <div class="Contents">
                <div id="Contents1">
                    ...
                    <!-- Restaurant LIST-->
                    <h2 id="H">List of the Restaurants</h2>
                    <!--Search box-->
                <div>           
                ...
                function filterTable() {
                    ...
                    <div id="Scrolable-Table">
                        <?php require_once('../Controllers/Admin_All_Rest_List.php');?>
                        <form method="post" action="../Controllers/Admin_All_Rest_List.php">
                            ...
                            <table id="Table" border="1">
                                ...
                                <tr id="TD">
                                    <td> <?php echo $r["Rest_Id"] ?> </td>
                                    <td> <?php echo $r["Rest_Name"] ?> </td>
                                    <td> <?php echo $r["Rest_Mobile"] ?> </td>
                                    <td> <?php echo $r["Rest_Address"] ?> </td>
                                    <td> <?php echo $r["Rest_Type"] ?> </td>
                                    <td> <?php echo $r["Rest_Rating"] ?> </td>
                                    <td> <?php echo $r["Rest_Revenue"] ?> </td>
                                    <td>
                    <form method="post" action="../Controllers/Admin_All_Rest_List.php">
                        <input type="hidden" name="Rest_Id" value="<?php echo $r['Rest_Id']; ?>">
                ...
                <div id="Contents2">
                    <div id="Add">
                        <h2 id="H">Insert New Restaurant</h2>
                        '*' Symbol included box should be filled to complete insertion.
                        <form method="post" action="../Controllers/Admin_Insrt_Rest.php">
                            ...
                            <?php
                            //Pop Up Code--------------------------------------------------------------
                            if(!empty($_SESSION['R_Insert1']))
                            { 
                            ?>
                            <script>swal("Success!", "Restaurant Added.", "success");</script>
                            <?php unset($_SESSION['R_Insert1']) ?>
                            <?php
                            }
                            else if(!empty($_SESSION['R_Insert2']))
                            { 
                            ?>
                            <script>swal("Failed", "Please, fill the box correctly.", "error");</script>
                            <?php unset($_SESSION['R_Insert2']) ?>
                            <?php
                            }
                            else if(!empty($_SESSION['R_Insert3']))
                            { 
                            ?>
                            <script>swal("Failed", "Please, fill the box correctly.", "error");</script>
                            <?php unset($_SESSION['R_Insert3']) ?>
                            <?php
                            }
                            ?>
                        </form>
                ...
                <div id="Contents3">
                    <div id="Update"> 
                        <h2 id="H">Update Existing Restaurant</h2><br>
                            <form method="post" action="../Controllers/Admin_Update_Rest.php">
                                ...
                                <?php
                                //Pop Up Code--------------------------------------------------------------
                                if(!empty($_SESSION['R_Update1']))
                                { 
                                ?>
                                <script>swal("Success!", "Restaurant Updated.", "success");</script>
                                <?php unset($_SESSION['R_Update1']) ?>
                                <?php
                                }
                                else if(!empty($_SESSION['R_Update2']))
                                { 
                                ?>
                                <script>swal("Failed", "Please, fill the box correctly.", "error");</script>
                                <?php unset($_SESSION['R_Update2']) ?>
                                <?php
                                }
                                ?>
                            </form>
